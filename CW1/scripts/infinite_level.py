...
#as in the case with body turn graphics, we need to specify conditions for rotating our image(here refer to variable where we did this)
    ...
    def reset(self):
        ...
        self.game_over_text = game_font.render(f"Game over", True, (170, 74, 68))
        self.score_text = game_font.render("This is level game will be closed automatically", True, (255, 255, 255))
        self.menu = game_font.render("Try one more time", True, (200,200,200))
...
LOOSE_SCREEN = pygame.image.load('images/you_win.jpg')
score = SNAKE.scrore
while True:
    for event in pygame.event.get():
       if  event.type == pygame.QUIT:
        pygame.quit()
        sys.exit()
        #accelarating the speed of the snake, by manipulation the fps speed
       n = 90
       if int(score - 3) % 10 == 0:
